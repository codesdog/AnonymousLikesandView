...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GenRoutinePlanUserControl.ascx.cs" Inherits="RoutinePlan.GenRoutinePlan.GenRoutinePlanUserControl" %>
<style type="text/css">
    .Appraise {
...
<div id="AppraiseDiv" class="Appraise" runat="server">
    ...
    <div style="padding-left: 20px;" id="errdiv">
        <asp:Label ID="lbErr" runat="server" Text="" ForeColor="red"></asp:Label>
        <br />
        <asp:Label ID="lbWaring" runat="server" Text="Label"></asp:Label>
        <asp:GridView ID="gvAllPlans" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="活动Url" DataTextField="活动对象" DataTextFormatString="查看活动详情" HeaderText="活动对象" />
                <asp:BoundField DataField="计划开始" HeaderText="计划开始" />
                <asp:BoundField DataField="计划时长" HeaderText="计划时长" />
            </Columns>
